...
@pytest.mark.parametrize("notstring", [(1, 1.1, [], (), ("name1",), ["name2"])])
...
namelistsinout = [
    ...
    (["ramp", "sine", "ramp", "sine"], ["ramp", "sine", "ramp2", "sine2"]),
...
@pytest.mark.parametrize(
    "attribute, val",
    [
        ("_funlist", [ramp, ramp, ramp]),
        ("_namelist", ["ramp", "ramp2", "ramp3"]),
        ("_argslist", [(0, 0), (1, 1), (0, 0)]),
        ("_durslist", [1, 0.5, 1]),
        ("marker1", []),
        ("marker2", []),
        ("_segmark1", [(0, 0)] * 3),
...
@pytest.mark.parametrize(
    "name, arg",
    [("ramp", "freq"), ("ramp", -1), ("ramp", 2), ("ramp2", ""), ("ramp4", 1)],
)
...
def test_add_two_identical(blueprint_tophat):
    ...
    assert new_bp1._namelist == ["ramp", "ramp2", "ramp3", "ramp4", "ramp5", "ramp6"]

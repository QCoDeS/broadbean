...
class Element:
    ...
    def add_blueprint(self, channel: str | int, blueprint: BluePrint) -> None:
        """
    ...
    def add_flags(self, channel: str | int, flags: Sequence[str | int]) -> None:
        """
    ...
    def addFlags(
        ...
        self.add_flags(channel, flags)

    @deprecate(reason="Does not adhear to PEP8", alternative="add_array")
    def addArray(
        self, channel: Union[int, str], waveform: np.ndarray, SR: int, **kwargs
    ) -> None:
        self.add_array(channel, waveform, SR, **kwargs)
    ...
    def changeArg(
        ...
        self.change_blueprint_argument(channel, name, arg, value, replaceeverywhere)
    ...
    def changeDuration(
        ...
        self.change_duration(channel, name, newdur, replaceeverywhere)

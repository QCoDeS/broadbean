...
class PulseSequence:
    ...
    def __eq__(self, other: PulseSequence) -> bool:
    ...
    def init_from_json(cls, path_to_file: str) -> PulseSequence:
        ...
        new_instance = PulseSequence.sequence_from_description(data_loaded)
        return new_instance
...
@deprecate(
    reason="Class name signature should not be the same as Type Sequence",
    alternative="PulseSequence",
)
class Sequence(PulseSequence):
    pass
